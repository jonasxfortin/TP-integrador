function usrpas() {
    if (document.form1.txt.value == "admin" && document.form1.num.value == "1234") { window.location = "index.html" }
...
function compraMenu1(){
    ...
    let confirmado = confirm("Tu orden de "+cantMenu1+" "+nombMenu+" tiene un valor de "+precioMenu*cantMenu1)
    if (cantMenu1>1){
        nombMenu="Hamburguesas"
    }
    if (confirmado){
        let compraConfirmada = document.createElement("p")
        compraConfirmada.innerHTML="Tu orden de "+cantMenu1+" "+nombMenu+" tiene un valor de "+precioMenu*cantMenu1
...
function compraMenu2(){
    ...
    let confirmado = confirm("Tu orden de "+cantMenu2+" "+nombMenu2+" tiene un valor de "+precioMenu2*cantMenu2)
    if (cantMenu2>1){
        nombMenu2="Milanesas a la napolitana"
    }
    if (confirmado){
        let compraConfirmada = document.createElement("p")
        compraConfirmada.innerHTML="Tu orden de "+cantMenu2+" "+nombMenu2+" tiene un valor de "+precioMenu2*cantMenu2
        let pedidoAgre = document.getElementById("nuevoPedido")
        pedidoAgre.appendChild(compraConfirmada)
    }  
}
...
function compraMenu3(){
    ...
    let confirmado = confirm("Tu orden de "+cantMenu3+" "+nombMenu3+" tiene un valor de "+precioMenu3*cantMenu3)
    if (cantMenu3>1){
        nombMenu3="Pizzas"
    }
    if (confirmado){
        let compraConfirmada = document.createElement("p")
        compraConfirmada.innerHTML="Tu orden de "+cantMenu3+" "+nombMenu3+" tiene un valor de "+precioMenu3*cantMenu3
        let pedidoAgre = document.getElementById("nuevoPedido")
        pedidoAgre.appendChild(compraConfirmada)
    }  
}
...
function compraMenu4(){
    ...
    let confirmado = confirm("Tu orden de "+cantMenu4+" platos de "+nombMenu4+" tiene un valor de "+precioMenu4*cantMenu4)
    if (cantMenu4>1){
        nombMenu4="platos de Ravioles"
    }
    if (confirmado){
        let compraConfirmada = document.createElement("p")
        compraConfirmada.innerHTML="Tu orden de "+cantMenu4+" "+nombMenu4+" tiene un valor de "+precioMenu4*cantMenu4
        let pedidoAgre = document.getElementById("nuevoPedido")
        pedidoAgre.appendChild(compraConfirmada)
    }  
}
